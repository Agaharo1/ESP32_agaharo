...
static uint8_t font8x8_basic_tr[128][8] = {
    ...
    { 0x00, 0x00, 0x00, 0x06, 0x09, 0x09, 0x06, 0x00 },   // U+007E (°) He tenido que crear el caracter y sustituirlo por ~
    { 0x00, 0x00, 0x60, 0xF0, 0xF0, 0x60, 0x00, 0x00 }    // U+007F (.) He tenido que crear el caracter es un poco más grande que el normal
};
